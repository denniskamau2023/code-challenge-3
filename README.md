# code-challenge-3The function show movie data creates a list of inner html texts which are appended to the DOM and later on passed on in the showMovie Data
